...
const SkillPage = () => {
  return (
    <div className="min-h-screen container flex items-center pt-24 flex-col">
      ...
      <span className="text-lg text-muted-foreground text-center">Curso on-line, de alto desempenho, com aulas semanais ao vivo, material exclusivo e atualizado, plantões, correções e muito mais!</span>
      <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-12 mt-8 md:mt-40">
        <SkillCard
