...
import { CardWithForm } from "./card-whatsapp";
    ...
    <div className="container transition-all duration-150 h-screen flex items-center justify-center">
      <div className="flex w-full items-center justify-center relative flex-col xl:justify-evenly xl:flex-row gap-8 xl:gap-0">
        <div className="flex flex-col items-start justify-start text-start">
            <h1 className="text-[42px] lg:text-[64px] font-bold lg:w-[540px] pb-8">Venha aprender a fazer uma boa redação.</h1>
            <span className="text-md lg:text-xl lg:w-[400px]">Curso on-line, de alto desempenho, com aulas semanais ao vivo, material exclusivo e atualizado, plantões, correções e muito mais!</span>
            <Button className="h-[50px] text-lg font-[500] mt-20">Entre em contato</Button>
        </div>
